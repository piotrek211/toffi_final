...
#ifndef AUTOMODE_CONTROLLER_EPUCK_H
#define AUTOMODE_CONTROLLER_EPUCK_H
...
namespace argos{
	class AutoMoDeControllerEpuck: public AutoMoDeController {
		public:
			/*
			 * Class constructor.
			 */
			AutoMoDeControllerEpuck();

			/*
			 * Class desctructor.
			 */
			virtual ~AutoMoDeControllerEpuck();
