...
#include "AutoMoDeControllerEpuck.h"
...
namespace argos {
	...
	AutoMoDeControllerEpuck::AutoMoDeControllerEpuck() {
	...
	void AutoMoDeControllerEpuck::Init(TConfigurationNode& t_node) {
		// Parsing parameters
		try {
	...
	void AutoMoDeControllerEpuck::ControlStep() {
		/*
		 * 1. Update RobotDAO
		 */
	...
	void AutoMoDeControllerEpuck::Destroy() {}

	/****************************************/
	/****************************************/

	void AutoMoDeControllerEpuck::Reset() {
	...
	void AutoMoDeControllerEpuck::InitializeActuation() {
		/*
	...
	void AutoMoDeControllerEpuck::SetFiniteStateMachine(AutoMoDeFiniteStateMachine* pc_finite_state_machine) {
		m_pcFiniteStateMachine = pc_finite_state_machine;
		m_pcFiniteStateMachine->SetRobotDAO((void*) m_pcRobotState);
	...
	REGISTER_CONTROLLER(AutoMoDeControllerEpuck, "automode_controller_epuck");
}
