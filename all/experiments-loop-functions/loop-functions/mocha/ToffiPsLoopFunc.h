...
#ifndef TUTTI_PS_LOOP_FUNC
#define TUTTI_PS_LOOP_FUNC
...
class ToffiPsLoopFunction: public CoreLoopFunctions {
  public:
    ToffiPsLoopFunction();
    ToffiPsLoopFunction(const ToffiPsLoopFunction& orig);
    virtual ~ToffiPsLoopFunction();
