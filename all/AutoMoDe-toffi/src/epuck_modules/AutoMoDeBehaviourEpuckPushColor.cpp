...
#include "AutoMoDeBehaviourEpuckPushColor.h"
...
namespace argos {
    ...
    AutoMoDeBehaviourEpuckPushColor::AutoMoDeBehaviourEpuckPushColor() {
    ...
    AutoMoDeBehaviourEpuckPushColor::AutoMoDeBehaviourEpuckPushColor(AutoMoDeBehaviourEpuckPushColor* pc_behaviour) {
    ...
    AutoMoDeBehaviourEpuckPushColor* AutoMoDeBehaviourEpuckPushColor::Clone() {
        return new AutoMoDeBehaviourEpuckPushColor(this);   // todo: check without *
	}
    ...
    void AutoMoDeBehaviourEpuckPushColor::ControlStep() {
        ...
        for (it = sReadings.BlobList.begin(); it != sReadings.BlobList.end(); it++) {
            //if ((*it)->Color == m_cColorReceiverParameter && (*it)->Distance > 30.0) {
    ...
    void AutoMoDeBehaviourEpuckPushColor::Init() {
    ...
    void AutoMoDeBehaviourEpuckPushColor::Reset() {
    ...
    void AutoMoDeBehaviourEpuckPushColor::ResumeStep() {
		m_bOperational = true;
	}
}
