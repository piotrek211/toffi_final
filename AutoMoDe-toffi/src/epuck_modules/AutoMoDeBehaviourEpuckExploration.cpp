...
#include "AutoMoDeBehaviourEpuckExploration.h"
...
namespace argos {
	...
	AutoMoDeBehaviourEpuckExploration::AutoMoDeBehaviourEpuckExploration() {
	...
	AutoMoDeBehaviourEpuckExploration::AutoMoDeBehaviourEpuckExploration(AutoMoDeBehaviourEpuckExploration* pc_behaviour) {
	...
	AutoMoDeBehaviourEpuckExploration* AutoMoDeBehaviourEpuckExploration::Clone() {
		return new AutoMoDeBehaviourEpuckExploration(this);
	}

	/****************************************/
	/****************************************/

	void AutoMoDeBehaviourEpuckExploration::Init() {
		m_unTurnSteps = 0;
	...
	void AutoMoDeBehaviourEpuckExploration::ControlStep() {
	...
	void AutoMoDeBehaviourEpuckExploration::Reset() {
	...
	void AutoMoDeBehaviourEpuckExploration::ResumeStep() {
		m_bOperational = true;
	}
	...
	bool AutoMoDeBehaviourEpuckExploration::IsObstacleInFront(CCI_EPuckProximitySensor::SReading s_prox_reading) {
